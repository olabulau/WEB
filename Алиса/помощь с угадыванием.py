...
cities = {
    'москва': ['213044/d6a2ec5078bdeb9eddcd',
               '997614/c46befe7c3667329a1a2'],
    'нью-йорк': ['1652229/f59f9f407166d9f2d5da',
                 '1652229/23e067ebfd3f250f1f01'],
    'париж': ["937455/8297a78bdf45f8f12f7e",
              '213044/41d422e44142cb205940']
}
...
def get_first_name(req):
    for entity in req['request']['nlu']['entities']:
        if entity['type'] == 'YANDEX.FIO':  # проверка имя или не имя
